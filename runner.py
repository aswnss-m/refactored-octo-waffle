"""
This file is to test run the sumo network
"""
...
MIN_DISTANCE = 20 # the minimum headway required between the leader and follower
MAX_DISTANCE = 50 # the maximum headway possible between the leader and follower
...
def run():
    ...
    df.to_csv('runner_result.csv', index=False)
    traci.close()
